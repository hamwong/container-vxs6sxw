...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vxs6sxw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vxs6sxw.containers.anotherwebservice.com/
...
```
git clone git@github.com:hamwong/container-vxs6sxw.git
cd container-vxs6sxw
```
...
```
docker attach container-vxs6sxw
```
